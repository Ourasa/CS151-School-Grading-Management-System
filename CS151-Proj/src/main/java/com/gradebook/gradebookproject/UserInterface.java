...
// * User requests something through UserInterface. This may call a command from
// Controller.
// * Controller may call a command from GradeSystem. GradeSystem takes action.
// *
// * In order to determine what can be shown to the user and what cannot, it
// will need to know
// * what instance the current user is. Thankfully, since only one user can be
// logged in at any moment,
// * this class only needs to request to see which one it is without any
// arguments.
// *
// *
// ==============================================================================================================================
...
// GradeSystem is through Strings.
// * This is because the goal is to only have a Controller variable in this
// class. This is why GradeSystem utilizes
...
// *
// * - JScrollPane will automatically make something have scroll bars as need,
// but
// * ONLY IF the "preferred size" of the panel, container, etc. is smaller than
// what is shown.
// * This means you will need to use (container
// name).setPreferredSize(Dimension)
// *
// * - Also, in the case a page is made to be scrollable, you only need to add
// the JScrollPane into the Frame.
// */
//
...
//
// //Admin - Remove a user from system : Probably a drop down box containing
// IDs? Then a confirm button to complete removal... I think
...
//
// //Admin - Add a course into system: TextFields, a drop down box for
// Professor, and confirm button.
...
//
// //Admin - Add Student to a Course : 2 drop down boxes, one for courses, one
// for student. Then a confirm button.
//
// //Admin - Remove Student from a Course: 2 drop down boxes, one for the
// course, and one for its current student. Then a confirm button.
//
...
//
// String[] adminOptions = {"Add User", "Remove User", "Add Course", "Remove
// Course" , "Set Professor for Course", "Remove Professor from Course", "Add
// Student to Course", "Remove Student from Course", "View All Users"};
...
//
// String[] profOptions = {"Add Student to Course", "Remove Student from
// Course", "Add an Assignment", "Edit an Assignment", "Remove an Assignment",
...
//
// removeUserDeniedLabel = new JLabel("Denied: Must have minimum 1 Admin in
// System.");
...
// viewUsersExitBtn.setBounds(40, 80 + 20 * i, 100, 25); //Adjusts location of
// exit button depending on # of users
// }
// viewUsersPanel.add(viewUsersExitBtn);
//
// if (arr.size() < 25) {
...
// } else {
// viewUsersPanel.setPreferredSize(new Dimension(600, 600)); //Ensures we don't
// have an oversized window.
// }
// }
...
// their own classes.
// * This will make things a LOT neater, as they can have their own
// actionListeners that way.
// * Not only that, but the variables should become easier to read, since they
...
//
// } else if (((String)adminOptionsBox.getSelectedItem()).equals("Remove
// Course")) {
// updateAdminRemoveCourseScreen();
// pageTransition(adminOptionScroll, removeCourseScroll);
//
// } else if (((String)adminOptionsBox.getSelectedItem()).equals("Set Professor
// for Course")) {
//
//
// } else if (((String)adminOptionsBox.getSelectedItem()).equals("Remove
// Professor from Course")) {
//
//
// } else if (((String)adminOptionsBox.getSelectedItem()).equals("Add Student to
// Course")) {
//
//
// } else if (((String)adminOptionsBox.getSelectedItem()).equals("Remove Student
// from Course")) {
//
//
// } else if (((String)adminOptionsBox.getSelectedItem()).equals("View All
// Users")) {
...
//
// if (((String)profOptionsBox.getSelectedItem()).equals("Add Student to
// Course")) {
// pageTransition(profOptionScroll, addStudentScroll);
//
// } else if (((String)profOptionsBox.getSelectedItem()).equals("Remove Student
// from Course")){
//
//
// } else if (((String)profOptionsBox.getSelectedItem()).equals("Add an
// Assignment")) {
//
//
// } else if (((String)profOptionsBox.getSelectedItem()).equals("Edit an
// Assignment")) {
//
//
// } else if (((String)profOptionsBox.getSelectedItem()).equals("Remove an
// Assignment")) {
//
//
// } else if (((String)profOptionsBox.getSelectedItem()).equals("View Students +
// Grades")) {
//
//
//
